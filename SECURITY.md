...
VaultSync is designed with a **Zero-Trust Coordinator** architecture:
...
Keys can be rotated at any time by calling `VaultSyncClient::rotate_keys()`.
...
Critical cryptographic modules are located under `crates/vaultsync-core/src/e2ee/`:
