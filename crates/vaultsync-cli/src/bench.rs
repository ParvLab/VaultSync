...
fn run_bench<F: FnMut()>(mut f: F, duration: Duration, iterations: Option<u64>) -> BenchResult {
...
pub fn run(args: BenchArgs) {
    ...
    match args.scenario.as_str() {
        ...
        "e2e_sync" => {
            println!("e2e_sync requires a live coordinator. Use: cargo bench -p vaultsync-core");
        }
        other => {
