...
pub fn gc_tombstones(doc: &mut CRDTDocument, config: &CompactionConfig) -> Result<Vec<u8>, DriftError> {
...
pub fn compact(doc: &mut CRDTDocument, oplog_len: &mut usize, _config: &CompactionConfig) -> Result<Vec<u8>, DriftError> {
