...
impl DebugApi {
    ...
    pub fn start(
        ...
        tokio::spawn(async move {
            ...
            let app = Router::new()
                .route("/debug/drift/state", get(handle_state))
                .route("/debug/drift/state/oplog", get(handle_oplog))
                .route("/debug/drift/state/documents", get(handle_documents))
                .route("/debug/drift/state/keys", get(handle_keys))
                .route("/debug/drift/state/replicas", get(handle_replicas))
                .route("/debug/drift/metrics", get(handle_metrics))
                .route("/debug/drift/traces", get(handle_traces))
                .route("/debug/drift/leader", get(handle_leader))
                .route("/debug/drift/force-sync", post(handle_force_sync))
                .route("/debug/drift/force-election", post(handle_force_election))
