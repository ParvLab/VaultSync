...
pub fn build_router(state: AppState) -> axum::Router {
    axum::Router::new()
        ...
        .route("/namespace/:ns/snapshot/:doc_id/:record_id", axum::routing::get(routes::get_snapshot).post(routes::store_snapshot))
        .route("/namespace/:ns/snapshots", axum::routing::get(routes::list_snapshots))
        .route("/namespace/:ns/compact", axum::routing::post(routes::compact_oplog))
